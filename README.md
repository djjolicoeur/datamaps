...
manipulate and query data only while in scope, this will do the trick.
...
This is really handy if I want to filter and pull a sub-map from that data, for instance
if I want all neighborhoods with a 21224 zip code
